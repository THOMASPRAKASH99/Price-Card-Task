     ...
     <div className="card mb-5 mb-lg-0">
       <div className="card-body">  
         ...
         <ul className="fa-ul">
           ...
           <li className={props.data.isCoummunityAccess?"":"text-muted"}><span className="fa-li"><i className={props.data.isCoummunityAccess?"fas fa-check":"fas fa-times"}></i></span>{props.data.communityAccess}</li>
           ...
           <li className={props.data.isReports?"":"text-muted"}><span className="fa-li"><i className={props.data.isReports?"fas fa-check":"fas fa-times"}></i></span>
